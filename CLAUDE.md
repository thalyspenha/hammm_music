...
- Cor extraída de capa (`palette_generator`) passa sempre por `accentFromPalette()` (`app_theme.dart`) antes de virar cor de destaque — garante contraste com o fundo escuro e descarta cinzas.
