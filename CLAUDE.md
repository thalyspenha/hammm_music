...
- `minSdk 26`, `compileSdk 37`, AGP 9.4.1 / Gradle 9.6.1, `targetSdk 34`, Java/Kotlin 17.
...
- Cor extraída de capa (`seedColorFromPixels()`, `material_color_utilities`) passa sempre por `accentFromPalette()` (`app_theme.dart`) antes de virar cor de destaque — garante contraste com o fundo escuro e descarta cinzas.
